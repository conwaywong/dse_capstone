...
public class Traffic5MinReader extends AbstractGenericTransform {
	...
	public void execute() throws ComponentNotReadyException {
		...
		outlog.log(Level.INFO, "InputFile = " + getProperties().getStringProperty("InputFile"));
		outlog.log(Level.INFO, "SeqName = " + getProperties().getStringProperty("SeqName"));
